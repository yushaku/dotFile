return {
  ...
  keys = {
    ...
    -- { "<leader>k", "<CMD>:HopWordBC<CR>", desc = "jump backward every where" },
    -- { "<leader>j", "<CMD>:HopWordAC<CR>", desc = "jump forward every where" },
    ...
    { "sw", "<CMD>:HopChar2<CR>", desc = "jump to 2 char every where" },
