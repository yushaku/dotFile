...
vim.g.mapleader = 'g'
vim.keymap.set("n", "<leader>h", ":DiffviewFileHistory %<CR>", opts)
vim.keymap.set("n", "<leader>t", ":DiffviewFileHistory<CR>", opts)
...
diffview.setup({
  ...
  keymaps = {
    ...
    file_history_panel = {
      ...
      { "n", "<C-S-d>",       actions.open_in_diffview,            { desc = "Open the entry under the cursor in a diffview" } },
